...
function Header() {
  const [navBackground, setNavBackground] = useState(false)
    ...
    return (
        <>
        <Navbar expand="md" collapseOnSelect style={{ transition: '1s ease',backgroundColor: navBackground ? '#c1edf3' : 'transparent',marginLeft: '2%', marginRight:'2%'}} fixed="top" variant="light" className="p-4">
